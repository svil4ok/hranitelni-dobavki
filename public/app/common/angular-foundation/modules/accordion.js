...
.controller('AccordionController', function ($scope, $attrs, accordionConfig) {

  // This array keeps track of the accordion groups
  this.groups = [];

  // Ensure that all the groups in this accordion are closed,
  // unless close-others explicitly says not to
  ...
  // This is called from the accordion-group
  // directive to add itself to the accordion
...
.directive('accordionGroup', ['$parse', function ($parse) {
  return {
    ...
    controller: function () {
      this.setHeading = function (element, scrollTo) {
        this.heading = element;
        this.heading.scrollTo = scrollTo;
      };
    },
...
.directive('accordionHeading', function () {
  return {
    ...
    compile: function (element, attrs, transclude) {
      return function link(scope, el, attr, accordionGroupCtrl) {
        // Pass the heading to the accordion-group controller
        // so that it can be transcluded into the right place in the template
        // [The second parameter to transclude causes the elements to be cloned so that they work in ng-repeat]
        accordionGroupCtrl.setHeading(transclude(scope, function () {}), attr.scrollTo);
      };
    }
  };
})
    ...
    link: function (scope, element, attr, controller) {
      scope.$watch(function () {
        ...
        if (heading) {
          ...
          scope.scrollToEl = heading.scrollTo;
        }
      });
    }
  };
